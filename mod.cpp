name = "Palladium: COBALT {version}";

author = "Bluefield";

picture         = "/img/cobalt_1024.paa";                                                                                               // Picture displayed from the expansions menu. Optimal size is 2048x1024
hideName        = "false";                                                                                                                          // Hide the extension name
hidePicture     = "false";                                                                                                                          // Hide the extension menu

logoSmall       = "/img/cobalt_64.paa";                                                                                                    // Display next to the item added by the mod 64x64
logo            = "/img/cobalt_128.paa";                                                                                                   // Logo displayed in the main menu 128x128
logoOver        = "/img/cobalt_128.paa";                                                                                                     // When the mouse is over, in the main menu 128x128

tooltip         = "3rd Shock Army's SCI FI Repack";
...
overviewPicture = "img/cobalt_1024.paa";
